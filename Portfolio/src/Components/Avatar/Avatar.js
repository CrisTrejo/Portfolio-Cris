...
export default function Avatar(props) {
  const group = useRef()
  const { nodes, materials, animations, scene } = useGLTF('/AvatarTerminado.gltf')
  
  const { actions } = useAnimations(animations, group )
  console.log(actions, "soy las actions")
  console.log(animations, "soy animations")
...
useGLTF.preload('/AvatarTerminado.gltf')
